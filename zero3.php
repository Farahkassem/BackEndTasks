...
var_dump(file_exists("farah.txt"));
echo '<br>';
 echo filesize("farah.txt");
echo '<br>';
...
echo '<br>';
// ---vid 87-->
$handle = fopen("farah.txt","a");

fwrite($handle,'i love elzero web school');

$handle = fopen("farah.txt","a+");
 
$handle = fopen("farah.txt","x");
...
// ---- vid 88 ---->
// echo "<pre>";
// print_r(file("farah.txt"));
// echo "</pre>";
// echo count(file("farah.txt"));

$handle = fopen("farah.txt","r");
